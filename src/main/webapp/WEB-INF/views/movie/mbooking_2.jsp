...
<body>
	...
	<form name="f" action="mwrite_4.wo" class="form" id="form" name="form"
	...
	<div class="line" style=" border-top: 2px solid #ff2f4a; margin: 0 auto; width:100px;"></div>
		...
		<strong style="font-size: 29px;">예 약 정 보</strong></p>
	</div>
			...
			<tbody>
				<tr height="10" align="center">
					<td colspan="2" style="background: #ff2f4a;"><font
						color=#ffffff><b>예약 정보</b></font></td>
				</tr>
				<!-- 장소를 출력 -->
				...
				<tr>
					...
					<td><input type="text" style="width: 170px"
						value="${mwrite_2.mplace }" disabled="disabled"><input
						type="hidden" name="mplace" value="${mwrite_2.mplace }" /></td>
				</tr>
				<!-- 펜션이름을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					...
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${mwrite_2.mname }" disabled="disabled"><input
						type="hidden" name="mname" value="${mwrite_2.mname }" /></td>
				</tr>
				<!-- 방이름을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					<th><b>극장</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${mwrite_2.mroom }" disabled="disabled"><input
						type="hidden" name="mroom" value="${mwrite_2.mroom }" /></td>
				</tr>
				<!-- 인원을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					<th><b>인원</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${mwrite_2.mpersonnel}" disabled="disabled"><input
						type="hidden" name="mpersonnel" value="${mwrite_2.mpersonnel }" /></td>
				</tr>
				<!-- 체크인을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					<th><b>날짜</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${mwrite_2.mday }" disabled="disabled"><input
						type="hidden" name="mday" value="${mwrite_2.mday }" /></td>
				</tr>
				<!-- 체크아웃을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					<th><b>좌석</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${mwrite_2.seat }" disabled="disabled"><input
						type="hidden" name="seat" value="${mwrite_2.seat }" /></td>
				</tr>
				<!-- 가격을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					<th><b>가격</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${mwrite_2.mprice}" disabled="disabled"><input
						type="hidden" name="mprice" value="${mwrite_2.mprice }" /></td>
				</tr>
				<tr height="10" align="center">
					<td colspan="2" style="background: #ff2f4a;"><font
				...
				<tr height="10" align="center">
					<th colspan="2" style="background: #ff2f4a;"><font
						color="#fff"><b>결제방법</b> </font></th>
				</tr>
				<!-- 결제방법을 선택한다 -->
				<!-- 선택받은속성을 표시해준다 -->
				<!-- 입력받은 값을 보낸다 -->
				<tr height="10" align="center">
					<th colspan="2"><b><input type="radio" name="check"
							value="sin" onclick="OnOff(this.value,'con');">신용카드</b> <b><input
							type="radio" name="check" value="ge"
							onclick="OnOff(this.value,'con1');">계좌이체</b></th>
				</tr>
			</tbody>
		</table>
