...
public class write_3command implements Command{
	...
	public void execute(Model model) throws Exception {
		...
		try {
			dao.write_3(place, pname, proom, personnel, pprice, checkin, checkout, id, name, email, tel, questions, card, cardnumber, cardpass, cardterm, cardidnumber, bank, banknumber, bankpass, bankidnumber, bankmaster, check);
		} catch (Exception e) {
			throw new Exception();
		}
		
		dao.updateNow(proom, checkin, checkout);
	}
