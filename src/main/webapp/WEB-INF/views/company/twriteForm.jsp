		...
		<div id="footer" class="wrapper style2">
			<div class="container">
				...
				<table width="500" cellpadding="0" cellspacting="0" border="1">
					<form action="twrite" method="post" enctype="multipart/form-data">

						<tr>
							<td>
								<div class="row half" style="position: relative;">
									<div class="12u" style="margin-left: 250px;">
										<input class="text" type="text" name="tname" id="tname"
											style="width: 220px; float: left; margin-right: 30px;"
											placeholder="여행이름"> <input class="text" type="text"
											name="tplace" id="tplace"
											style="width: 220px; margin-bottom: 10px;" placeholder="여행지" />
									</div>
								</div>
							</td>
						</tr>
							...
							<div class="row half" style="position: relative;">
								<div class="12u" style="margin-left: 250px;">
									<div style="width: 220px; float: left; margin-right: 30px;">
										<input type="radio" name="tvehicle" value="비행기" size="50">비행기
										<input type="radio" name="tvehicle" value="버스" size="50">버스
										<input type="radio" name="tvehicle" value="배" size="50">배
									</div>
									<input class="text" type="text" name="tprice" id="tprice"
										style="width: 220px; margin-bottom: 10px;" placeholder="가격">
								</div>
							</div>
						</td>
					</tr>
					...
					<tr>
						<td>
							<div class="row half" style="position: relative;">
								<div class="12u" style="margin-left: 250px;">
									<input class="text" type="text" name="tpersonnel_min"
										id="tpersonnel_min"
										style="width: 220px; float: left; margin-right: 30px;"
										placeholder="최소인원"> <input class="text" type="text"
										name="tpersonnel_max" id="tpersonnel_max"
										style="width: 220px; margin-bottom: 10px;" placeholder="최대인원" />
								</div>
							</div>
						</td>
					</tr>
					<tr><td>
						<div class="row half" style="position: relative;">
							<div class="12u" style="margin-left: 250px;">
								<input readonly class="text" type="text" name="tstart"
									id="testDatepicker"
									style="width: 220px; float: left; margin-right: 30px;"
									placeholder="출발일"> <input readonly class="text" type="text"
									name="tend" id="testDatepicker1"
									style="width: 220px; margin-bottom: 10px;" placeholder="도착일" />
							</div>
						</div>
						</td></tr>
					<tr>
							<!-- <td>pimg</td> -->
							<td>이미지<input type="file" name="timg" size="30px"></td>
						</tr>
						</td></tr>
						<tr><td>
						<div class="row half" style="position: relative;">
							<div class="12u" style="margin-left: 250px;">
								<div class="12u">
									<textarea name="tm" placeholder="추가 입력 사항"
					...
					<tr>
						<td colspan="2"><input type="submit" value="등록">&nbsp;&nbsp;
							<a href="tlist"><input type="button" value="목록보기" /></a></td>
					</tr>
					</div>
					</form>
				</table>
