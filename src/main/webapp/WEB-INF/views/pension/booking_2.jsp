...
<body>
	...
	<form name="f" action="write_3.wo" class="form" id="form" name="form"
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" style="width: 170px"
						value="${write_2.place }" disabled="disabled"><input
						type="hidden" name="place" value="${write_2.place }" /></td>
				</tr>
				<!-- 펜션이름을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					...
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${write_2.pname }" disabled="disabled"><input
						type="hidden" name="pname" value="${write_2.pname }" /></td>
				</tr>
				<!-- 방이름을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				...
				<tr>
					<th><b>인원</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${write_2.personnel}" disabled="disabled"><input
						type="hidden" name="personnel" value="${write_2.personnel }" /></td>
				</tr>
				<!-- 체크인을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					<th><b>체크인</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${write_2.checkin }" disabled="disabled"><input
						type="hidden" name="checkin" value="${write_2.checkin }" /></td>
				</tr>
				<!-- 체크아웃을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					<th><b>체크아웃</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${write_2.checkout }" disabled="disabled"><input
						type="hidden" name="checkout" value="${write_2.checkout }" /></td>
				</tr>
				<!-- 가격을 출력 -->
				<!-- <input>을 2개 사용하였다 이방법을 사용했기에 쭈욱 이방법으로 했다-->
				<!-- 하나는 text로 하여 값을 출력해주고 하나는 hidden을 사용하여 숨긴뒤 name값으로 값만 보내줬다 --> 
				<tr>
					<th><b>가격</b></th>
					<td><input type="text" style="width: 170px" maxlength="18"
						value="${write_2.pprice}" disabled="disabled"><input
						type="hidden" name="pprice" value="${write_2.pprice }" /></td>
				</tr>
				<tr height="10" align="center">
					<td colspan="2" style="background: #ff2f4a;"><font
