...
.t1{ font-size:30px; color:#c32d2c; font-weight:bold; border:1px solid #000; border-left:none; border-right:none; padding:25px 0; margin-bottom:20px;text-transform:uppercase; margin-top:20px;}
.t2{ font-size:15px; color:#012e46; text-align: center; line-height:30px; font-weight:bold; margin-top:20px;}
...
<div class="wrap">
    <div class="va"></div>
    <div class="va_tt">
        <p class="t2"><img src="${pageContext.request.contextPath}/cimg/${mimg}" width="1250px" /> </p>
