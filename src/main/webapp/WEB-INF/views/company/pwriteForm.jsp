				...
				<table width="500" cellpadding="0" cellspacting="0" border="1">
					...
					<tr><td>
						<div class="row half" style="position: relative;">
							<div class="12u" style="margin-left: 250px;">
								<input class="text" type="text" name="pplace" id="pplace"
									style="width: 220px; float: left; margin-right: 30px;"
									placeholder="장소"> <input class="text" type="text"
									name="pname" id="pname"
									style="width: 220px; margin-bottom: 10px;" placeholder="펜션이름" />
							</div>
						</div>
						</td></tr>
						...
						<div class="row half" style="position: relative;">
							<div class="12u" style="margin-left: 250px;">
								<input class="text" type="text" name="proom" id="proom"
									style="width: 220px; float: left; margin-right: 30px;"
									placeholder="방이름"> <input class="text" type="text"
									name="pprice" id="pprice"
									style="width: 220px; margin-bottom: 10px;" placeholder="하루가격" />
							</div>
						</div>
						</td></tr>
						<tr><td>
						<div class="row half" style="position: relative;">
							<div class="12u" style="margin-left: 250px;">
								<input class="text" type="text" name="ppersonnel_min"
									id="ppersonnel_min"
									style="width: 220px; float: left; margin-right: 30px;"
									placeholder="기본인원"> <input class="text" type="text"
									name="ppersonnel_max" id="ppersonnel_max"
						...
						<div class="row half" style="position: relative;">
							<div class="12u" style="margin-left: 250px;">
								<input readonly class="text" type="text" name="pstart"
									id="testDatepicker"
									style="width: 220px; float: left; margin-right: 30px;"
									placeholder="등록 시작"> <input readonly class="text" type="text"
									name="pend" id="testDatepicker1"
									style="width: 220px; margin-bottom: 10px;" placeholder="등록마감" />
							</div>
						</div>
						</td></tr>
						<tr>
							<!-- <td>pimg</td> -->
							<td>이미지<input type="file" name="pimg" size="30px"></td>
						</tr>
						</td></tr>
						<tr><td>
						<div class="row half" style="position: relative;">
							<div class="12u" style="margin-left: 250px;">
								<div class="12u">
									<textarea name="pm" placeholder="추가 입력 사항"
					...
					<tr>
						<td colspan="2"><input type="submit" value="등록">&nbsp;&nbsp;
							<a href="plist"><input type="button" value="목록보기" /></a></td>
					</tr>
					</div>
					</form>
				</table>
