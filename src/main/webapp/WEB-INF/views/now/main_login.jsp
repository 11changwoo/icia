			...
			<div class="header-bottom">
				<div class="header-bottom__wrap">
					<ul class="gnb">
						...
						<li class="t"><a href="#"> <span style="line-height: 3.8;">업체</span>
						</a>
							<div class="gnb__wrap gnb__wrap--medium">
								<div class="row">
						...
						<li class="s"><a href="#"> <span style="line-height: 3.8;">관리</span>
						</a>
							<div class="gnb__wrap gnb__wrap--medium">
								<div class="row">
									<div class="gnb__wrap-box" style="margin-left: 685px;">
							...
							<div class="bx-viewport" aria-live="polite"
								...
								<ul class="main-brand__slider1"
									...
									<li aria-hidden="false"
										...
										href="main_m.wo" onclick="_gaq.push([]);"> <img
									...
									<li aria-hidden="false"
										style="float: left; list-style: none; position: relative; width: 118px; margin-right: 186px;"><a
										href="main.wo" onclick="_gaq.push([]);"> <img
									...
									<li aria-hidden="false"
										...
										href="travel" onclick="_gaq.push([]);"><img
			...
			<div class="footer__copyright">
				<div class="row">
					<div class="footer__copyright-logo">
						<img src="${pageContext.request.contextPath}/img/logo_gray.png" alt="1조 소개">
					</div>
					<div class="footer__copyright-addr" style="line-height : 28px">
						조장 : 임현택 / 조원 : 이창우 , 유소희 , 김지훈 <br> COPYRIGHT(C) ICIA
