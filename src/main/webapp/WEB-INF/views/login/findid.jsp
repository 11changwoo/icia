...
<p style=" font-size: 11px; color: #ff2f4a; margin-bottom: 20px;">본인확인 이름과 입력한 이메일 주소가 같아야, 아이디를 찾을수 있습니다.</p>
<form id="join" name="join" action="search.do" method="post">
 <input class="name_user" type="text" name="name" placeholder="name">
 <div class="email">
 <input class="name_e-mail" type="text" name="email_id" placeholder="e-mail"/>@
 <input class="name_e-mail" type="text" name="email_addr" disabled />
